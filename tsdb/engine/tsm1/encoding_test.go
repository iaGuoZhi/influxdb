...
func TestEncoding_FloatBlock_Temperature_Floats(t *testing.T) {
	...
	//temperatures := [...]float64{64.2, 49.4, 48.8, 46.4, 47.9, 48.7}
	//temperatures := [...]float64{64.2, 49.4}
...
func TestEncoding_Stocks_Germany_All(t *testing.T) {
	size := 1000
	layout := "01/02/2006 15:04:05"
	values := make([]tsm1.Value, size)

	f, err := os.Open("/run/media/panagiotis/DATA/Stocks/Stocks-Germany.txt.gz")
	defer f.Close()
	gz, err := gzip.NewReader(f)
	if err != nil {
		fmt.Println(err)
...
func TestEncoding_Stocks_UK_All(t *testing.T) {
	size := 1000
	layout := "01/02/2006 15:04:05"
	values := make([]tsm1.Value, size)

	f, err := os.Open("/run/media/panagiotis/DATA/Stocks/Stocks-UK.txt.gz")
	defer f.Close()
	gz, err := gzip.NewReader(f)
	if err != nil {
		fmt.Println(err)
...
func TestEncoding_Stocks_USA_All(t *testing.T) {
	size := 1000
	layout := "01/02/2006 15:04:05"
	values := make([]tsm1.Value, size)

	f, err := os.Open("/run/media/panagiotis/DATA/Stocks/Stocks-USA.txt.gz")
	defer f.Close()
	gz, err := gzip.NewReader(f)
	if err != nil {
		fmt.Println(err)
...
func TestEncoding_Temp_Air_FNLT(t *testing.T) {
	size := 1000
	layout := "2006-01-02T15:04:05Z"
	values := make([]tsm1.Value, size)

	f, err := os.Open("/run/media/panagiotis/DATA/Stocks/NEON_temp-air-buoy-FNLT.csv.gz")
	defer f.Close()
	gz, err := gzip.NewReader(f)
	if err != nil {
		fmt.Println(err)
...
func TestEncoding_Wind_ABBY(t *testing.T) {
	size := 1000
	layout := "2006-01-02T15:04:05Z"
	values := make([]tsm1.Value, size)

	f, err := os.Open("/run/media/panagiotis/DATA/Stocks/ABBY.csv.gz")
	defer f.Close()
	gz, err := gzip.NewReader(f)
	if err != nil {
		fmt.Println(err)
